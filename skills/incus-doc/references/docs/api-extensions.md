...
See [Instance configuration](../explanation/instance_config/#instance-config) for how to use them.
...
-   All the network configuration options (see [Network configuration](../networks/) for details)

-   [`POST`]` `[`/1.0/networks`] (see [RESTful API](../rest-api/) for details)

-   [`PUT`]` `[`/1.0/networks/<entry>`] (see [RESTful API](../rest-api/) for details)

-   [`PATCH`]` `[`/1.0/networks/<entry>`] (see [RESTful API](../rest-api/) for details)

-   [`DELETE`]` `[`/1.0/networks/<entry>`] (see [RESTful API](../rest-api/) for details)
...
-   [`POST`]` `[`/1.0/storage-pools`] (see [RESTful API](../rest-api/) for details)

-   [`GET`]` `[`/1.0/storage-pools/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`POST`]` `[`/1.0/storage-pools/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`PUT`]` `[`/1.0/storage-pools/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`PATCH`]` `[`/1.0/storage-pools/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`DELETE`]` `[`/1.0/storage-pools/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`GET`]` `[`/1.0/storage-pools/<name>/volumes`] (see [RESTful API](../rest-api/) for details)

-   [`GET`]` `[`/1.0/storage-pools/<name>/volumes/<volume_type>`] (see [RESTful API](../rest-api/) for details)

-   [`POST`]` `[`/1.0/storage-pools/<name>/volumes/<volume_type>`] (see [RESTful API](../rest-api/) for details)

-   [`GET`]` `[`/1.0/storage-pools/<pool>/volumes/<volume_type>/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`POST`]` `[`/1.0/storage-pools/<pool>/volumes/<volume_type>/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`PUT`]` `[`/1.0/storage-pools/<pool>/volumes/<volume_type>/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`PATCH`]` `[`/1.0/storage-pools/<pool>/volumes/<volume_type>/<name>`] (see [RESTful API](../rest-api/) for details)

-   [`DELETE`]` `[`/1.0/storage-pools/<pool>/volumes/<volume_type>/<name>`] (see [RESTful API](../rest-api/) for details)

-   All storage configuration options (see [Storage configuration](../storage/) for details)
...
This includes the following new endpoints (see [RESTful API](../rest-api/) for details):
...
This adds the following new endpoint (see [RESTful API](../rest-api/) for details):
...
This effectively allows for [[[`incus`]` `[`list`]]](../reference/manpages/incus/list/#incus-list-md) to get all it needs in one query.
...
option [`snapshots.expiry`] takes an expression in the form of [`1M`]` `[`2H`]` `[`3d`]` `[`4w`]` `[`5m`]` `[`6y`] (1 minute, 2 hours, 3 days, 4 weeks, 5 months, 6 years), however not all
...
using the API or [[[`incus`]` `[`config`]` `[`edit`]]](../reference/manpages/incus/config/edit/#incus-config-edit-md). Snapshots with a valid expiry date will be
...
This introduces the [`lxc_features`] section output from the [[[`incus`]` `[`info`]]](../reference/manpages/incus/info/#incus-info-md) command
...
Adds the following endpoint for bulk state change (see [RESTful API](../rest-api/) for details):
...
This includes the following endpoints (see [Restful API](../rest-api/) for details):
...
This extension adds the ability to rebuild an instance with the same origin image, alternate image or as empty. A new [`POST`]` `[`/1.0/instances/<name>/rebuild?project=<project>`] API endpoint has been added as well as a new CLI command [[[`incus`]` `[`rebuild`]]](../reference/manpages/incus/rebuild/#incus-rebuild-md).
...
This adds the [`--type`] flag to [[[`incus`]` `[`storage`]` `[`volume`]` `[`import`]]](../reference/manpages/incus/storage/volume/import/#incus-storage-volume-import-md).

## [`network_allocations`]

This adds the possibility to list an Incus deployment's network allocations.

Through the [[[`incus`]` `[`network`]` `[`list-allocations`]]](../reference/manpages/incus/network/list-allocations/#incus-network-list-allocations-md) command and the [`--project`]` `[`<PROJECT>`]` `[`|`]` `[`--all-projects`] flags,
