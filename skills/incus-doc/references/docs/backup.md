...
addition, recorded in the [Incus database](../database/#database).
...
6.  Restart Incus (for example, with
...
its instance volume, see [Storage volume types](../explanation/storage/#storage-volume-types)).

See [How to back up instances](../howto/instances_backup/#instances-backup) and [How to back up custom storage volumes](../howto/storage_backup_volume/#howto-storage-backup-volume) for detailed information.
...
See [How to move existing Incus instances between servers](../howto/move_instances/#move-instances) and [How to move or copy storage volumes](../howto/storage_move_volume/#howto-storage-move-volume) for instructions.
...
See [Use export files for instance backup](../howto/instances_backup/#instances-backup-export) and [Use export files for volume backup](../howto/storage_backup_volume/#storage-backup-export) for instructions.
...
See [Use snapshots for instance backup](../howto/instances_backup/#instances-snapshots) and [Use snapshots for volume backup](../howto/storage_backup_volume/#storage-backup-snapshots) for more information.
...
[Incus database](../database/#database), it can still be very convenient
