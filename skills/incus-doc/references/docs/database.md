...
See [Upgrade Incus](../installing/#installing-upgrade) for more information.

## Backup

See [Back up the database](../backup/#backup-database) for instructions on how to back up the contents of the Incus database.
