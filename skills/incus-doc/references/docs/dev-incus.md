...
[`security.guestapi`](../reference/instance_options/#instance-security:security.guestapi) must be set to [`true`] (which is the default) for an instance to allow access to the socket.
