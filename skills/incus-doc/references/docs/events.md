...
[[[`incus`]` `[`monitor`]]](../reference/manpages/incus/monitor/#incus-monitor-md) will connect to a WebSocket through which logs and life-cycle messages will be streamed.
