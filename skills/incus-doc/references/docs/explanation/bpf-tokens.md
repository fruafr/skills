...
If any of the instance options [`security.bpffs.delegate_cmds`](../../reference/instance_options/#instance-security:security.bpffs.delegate_cmds),
[`security.bpffs.delegate_maps`](../../reference/instance_options/#instance-security:security.bpffs.delegate_maps),
[`security.bpffs.delegate_progs`](../../reference/instance_options/#instance-security:security.bpffs.delegate_progs) or
[`security.bpffs.delegate_attachs`](../../reference/instance_options/#instance-security:security.bpffs.delegate_attachs) is set, Incus mounts a BPF file system into the
container at the path specified by the [`security.bpffs.path`](../../reference/instance_options/#instance-security:security.bpffs.path) option and delegates the
