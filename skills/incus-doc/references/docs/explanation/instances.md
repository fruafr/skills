...
:   VMs are a full virtualized system.
    ...
    To see which features are available for virtual machines, check the condition column in the [Instance options](../../reference/instance_options/#instance-options) documentation.
    :::

See [About containers and VMs](../containers_and_vms/#containers-and-vms) for more information about the different instance types.
