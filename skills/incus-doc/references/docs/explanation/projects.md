...
See [How to create and configure projects](../../howto/projects_create/#projects-create) for instructions on how to add projects.
...
In addition, this method allows users to work with Incus without being a member of the [`incus-admin`] group (see [Access to the Incus daemon](../security/#security-daemon-access)).
...
:   You can restrict the [TLS client certificates](../../authentication/#authentication-tls-certs) to allow access to specific projects only.
...
See [How to confine projects to specific users](../../howto/projects_confine/#projects-confine) for instructions on how to enable and configure the different authentication methods.
