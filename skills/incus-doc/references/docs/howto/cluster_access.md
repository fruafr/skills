...
and deploy a certificate across the cluster (see [TLS server certificate](../../authentication/#authentication-server-certificate)).
...
See [TLS client certificates](../../authentication/#authentication-tls-certs) for details.
...
See [OpenID Connect authentication](../../authentication/#authentication-openid) for details.
