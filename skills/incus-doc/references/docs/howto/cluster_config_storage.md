...
The only configuration keys that may differ between pools on different members are [[[`source`]]](../../reference/storage_drivers/#storage-drivers), [[[`size`]]](../../reference/storage_drivers/#storage-drivers), [[[`zfs.pool_name`]]](../../reference/storage_zfs/#storage-zfs-pool-config), [[[`lvm.thinpool_name`]]](../../reference/storage_lvm/#storage-lvm-pool-config) and [[[`lvm.vg_name`]]](../../reference/storage_lvm/#storage-lvm-pool-config).
See [Member configuration](../../explanation/clustering/#clustering-member-config) for more information.
...
1.  Define and configure the new storage pool across all cluster members.
    ...
    If you run [[[`incus`]` `[`storage`]` `[`list`]]](../../reference/manpages/incus/storage/list/#incus-storage-list-md), you can see that the pool is marked as "pending".
...
Running [[[`incus`]` `[`storage`]` `[`show`]` `[`<pool_name>`]]](../../reference/manpages/incus/storage/show/#incus-storage-show-md) shows the cluster-wide configuration of the storage pool.
...
Run [[[`incus`]` `[`storage`]` `[`volume`]` `[`list`]` `[`<pool_name>`]]](../../reference/manpages/incus/storage/volume/list/#incus-storage-volume-list-md) to see on which member a certain volume is located.
