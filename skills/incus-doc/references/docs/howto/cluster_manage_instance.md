...
You can launch instances on specific cluster members or on specific [cluster groups](../cluster_groups/#howto-cluster-groups).
...
See [How to move existing Incus instances between servers](../move_instances/#move-instances) for more information.
