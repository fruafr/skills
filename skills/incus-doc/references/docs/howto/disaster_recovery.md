...
Incus provides a tool for disaster recovery in case the [Incus database](../../database/#database) is corrupted or otherwise lost.
...
[`incus`]` `[`admin`]` `[`recover`]` `[`The`]` `[`following`]` `[`unknown`]` `[`volumes`]` `[`have`]` `[`been`]` `[`found:`]` `[`-`]` `[`Container`]` `[`"u1"`]` `[`on`]` `[`pool`]` `[`"default"`]` `[`in`]` `[`project`]` `[`"default"`]` `[`(includes`]` `[`0`]` `[`snapshots)`]` `[`-`]` `[`Container`]` `[`"u2"`]` `[`on`]` `[`pool`]` `[`"default"`]` `[`in`]` `[`project`]` `[`"default"`]` `[`(includes`]` `[`0`]` `[`snapshots)`][`Would`]` `[`you`]` `[`like`]` `[`those`]` `[`to`]` `[`be`]` `[`recovered?`]` `[`(yes/no)`]` `[`[default=no]:`]` `[`yes`][`Starting`]` `[`recovery...`]
...
[`+------+---------+-------------------+----------------------------------------------+-----------+-----------+`][`|`]` `[`NAME`]` `[`|`]`  `[`STATE`]`  `[`|`]`       `[`IPV4`]`        `[`|`]`                    `[`IPV6`]`                      `[`|`]`   `[`TYPE`]`    `[`|`]` `[`SNAPSHOTS`]` `[`|`][`+------+---------+-------------------+----------------------------------------------+-----------+-----------+`][`|`]` `[`u1`]`   `[`|`]` `[`RUNNING`]` `[`|`]` `[`192.0.2.49`]` `[`(eth0)`]` `[`|`]` `[`2001:db8:8b6:abfe:1266:6aff:fe82:918e`]` `[`(eth0)`]` `[`|`]` `[`CONTAINER`]` `[`|`]` `[`0`]`         `[`|`][`+------+---------+-------------------+----------------------------------------------+-----------+-----------+`][`|`]` `[`u2`]`   `[`|`]` `[`STOPPED`]` `[`|`]`                   `[`|`]`                                              `[`|`]` `[`CONTAINER`]` `[`|`]` `[`0`]`         `[`|`][`+------+---------+-------------------+----------------------------------------------+-----------+-----------+`]
