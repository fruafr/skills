...
See [[[`incus`]` `[`publish`]` `[`--help`]]](../../reference/manpages/incus/publish/#incus-publish-md) for a full list of available flags.
...
-   Instance metadata (use [[[`incus`]` `[`config`]` `[`metadata`]]](../../reference/manpages/incus/config/metadata/#incus-config-metadata-md) to edit)

-   File templates (use [[[`incus`]` `[`config`]` `[`template`]]](../../reference/manpages/incus/config/template/#incus-config-template-md) to edit)
