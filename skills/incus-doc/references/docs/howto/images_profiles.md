...
To associate a list of profiles with an image, use the [[[`incus`]` `[`image`]` `[`edit`]]](../../reference/manpages/incus/image/edit/#incus-image-edit-md) command and edit the [`profiles:`] section:
