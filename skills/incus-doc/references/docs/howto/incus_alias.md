...
Managing aliases is done through the [[[`incus`]` `[`alias`]]](#) command.

Within the [[[`incus`]` `[`alias`]]](#) command, you can use the following subcommands:
...
Run [[[`incus`]` `[`alias`]` `[`--help`]]](#) to see all available subcommands and parameters.

Note

*Command aliases* are different from *[image aliases](../../images/#images)*.
...
To create an alias, run [[[`incus`]` `[`alias`]` `[`add`]]](../../reference/manpages/incus/alias/add/#incus-alias-add-md) and provide the alias name and the alias command (enclosed in quotes).
...
To see all configured aliases, run [[[`incus`]` `[`alias`]` `[`list`]]](../../reference/manpages/incus/alias/list/#incus-alias-list-md).
...
To remove an existing command alias, type [[[`incus`]` `[`alias`]` `[`remove`]]](../../reference/manpages/incus/alias/remove/#incus-alias-remove-md)
...
To rename an existing command alias, type [[[`incus`]` `[`alias`]` `[`rename`]]](../../reference/manpages/incus/alias/rename/#incus-alias-rename-md),
...
[[[`incus`]` `[`exec`]]](../../reference/manpages/incus/exec/#incus-exec-md) command, executing [`exec`]` `[`@ARGS@`]` `[`--`]` `[`su`]` `[`-l`].
...
[[[`incus`]` `[`delete`]]](../../reference/manpages/incus/delete/#incus-delete-md) that always runs [`incus`]` `[`delete`]` `[`--interactive`].

The following command for [`incus`]` `[`alias`], will *add* the command alias with name [`delete`],
