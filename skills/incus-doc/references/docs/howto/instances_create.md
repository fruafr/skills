...
To create an instance, you can use either the [[[`incus`]` `[`init`]]](../../reference/manpages/incus/create/#incus-create-md) or the [[[`incus`]` `[`launch`]]](../../reference/manpages/incus/launch/#incus-launch-md) command.
The [[[`incus`]` `[`init`]]](../../reference/manpages/incus/create/#incus-create-md) command only creates the instance, while the [[[`incus`]` `[`launch`]]](../../reference/manpages/incus/launch/#incus-launch-md) command creates and starts it.
...
:   Images contain a basic operating system (for example, a Linux distribution) and some Incus-related information.
    ...
    See [Images](../../images/#images) for more information.
...
:   Instance names must be unique within an Incus deployment (also within a cluster).
    See [Instance properties](../../reference/instance_properties/#instance-properties) for additional requirements.

Flags

:   See [[[`incus`]` `[`launch`]` `[`--help`]]](../../reference/manpages/incus/launch/#incus-launch-md) or [[[`incus`]` `[`init`]` `[`--help`]]](../../reference/manpages/incus/create/#incus-create-md) for a full list of flags.
    The most common flags are:

    -   [`--config`] to specify a configuration option for the new instance

    -   [`--device`] to override [device options](../../reference/devices/#devices) for a device provided through a profile, or to specify an [initial configuration for the root disk device](../../reference/devices_disk/#devices-disk-initial-config)
...
Check the contents of an existing instance configuration ([[[`incus`]` `[`config`]` `[`show`]` `[`<instance_name>`]` `[`--expanded`]]](../../reference/manpages/incus/config/show/#incus-config-show-md)) to see the required syntax of the YAML file.

## Examples

The following examples use [[[`incus`]` `[`launch`]]](../../reference/manpages/incus/launch/#incus-launch-md), but you can use [[[`incus`]` `[`init`]]](../../reference/manpages/incus/create/#incus-create-md) in the same way.
...
See [How to use remote images](../images_remote/#images-remote) for instructions.
