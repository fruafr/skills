...
2.  Reboot the machine that runs your Incus server.
...
[`Console`]` `[`log:`]` `[`Failed`]` `[`to`]` `[`insert`]` `[`module`]` `[`'autofs4'`][`Failed`]` `[`to`]` `[`insert`]` `[`module`]` `[`'unix'`][`Failed`]` `[`to`]` `[`mount`]` `[`sysfs`]` `[`at`]` `[`/sys:`]` `[`Operation`]` `[`not`]` `[`permitted`][`Failed`]` `[`to`]` `[`mount`]` `[`proc`]` `[`at`]` `[`/proc:`]` `[`Operation`]` `[`not`]` `[`permitted`][`[!!!!!!]`]` `[`Failed`]` `[`to`]` `[`mount`]` `[`API`]` `[`filesystems,`]` `[`freezing.`]
...
The [container requirements](../../container-environment/) specify that every container must come with an empty [`/dev`], [`/proc`] and [`/sys`] directory, and that [`/sbin/init`] must exist.
...
[`[root@systemd`]` `[`~]#`]` `[`ls`][`[root@systemd`]` `[`~]#`]` `[`mount`][`mount:`]` `[`failed`]` `[`to`]` `[`read`]` `[`mtab:`]` `[`No`]` `[`such`]` `[`file`]` `[`or`]` `[`directory`][`[root@systemd`]` `[`~]#`]` `[`cd`]` `[`/`][`[root@systemd`]` `[`/]#`]` `[`ls`]` `[`/proc/`][`sys`][`[root@systemd`]` `[`/]#`]` `[`exit`]
