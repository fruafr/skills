...
Projects have a [`features.networks.zones`](../../reference/projects/#project-features:features.networks.zones) feature, which is disabled by default.
...
This assumes that [`core.dns_address`](../../server_config/#server-core:core.dns_address) was set to [`<DNS_server_IP>:<DNS_server_PORT>`]. (Setting that configuration
...
[`incus.example.net.`]`                        `[`3600`]` `[`IN`]` `[`SOA`]`  `[`incus.example.net.`]` `[`ns1.incus.example.net.`]` `[`1669736788`]` `[`120`]` `[`60`]` `[`86400`]` `[`30`][`incus.example.net.`]`                        `[`300`]`  `[`IN`]` `[`NS`]`   `[`ns1.incus.example.net.`][`inctest.gw.incus.example.net.`]`             `[`300`]`  `[`IN`]` `[`A`]`    `[`192.0.2.1`][`inctest.gw.incus.example.net.`]`             `[`300`]`  `[`IN`]` `[`AAAA`]` `[`fd42:4131:a53c:7211::1`][`default-ovntest.uplink.incus.example.net.`]` `[`300`]`  `[`IN`]` `[`A`]`    `[`192.0.2.20`][`default-ovntest.uplink.incus.example.net.`]` `[`300`]`  `[`IN`]` `[`AAAA`]` `[`fd42:4131:a53c:7211:1266:6aff:fe4e:b794`][`c1.incus.example.net.`]`                     `[`300`]`  `[`IN`]` `[`AAAA`]` `[`fd42:4131:a53c:7211:1266:6aff:fe19:6ede`][`c1.incus.example.net.`]`                     `[`300`]`  `[`IN`]` `[`A`]`    `[`192.0.2.125`][`manualtest.incus.example.net.`]`             `[`300`]`  `[`IN`]` `[`A`]`    `[`8.8.8.8`][`incus.example.net.`]`                        `[`3600`]` `[`IN`]` `[`SOA`]`  `[`incus.example.net.`]` `[`ns1.incus.example.net.`]` `[`1669736788`]` `[`120`]` `[`60`]` `[`86400`]` `[`30`]
...
To do so, set the [`core.dns_address`](../../server_config/#server-core:core.dns_address) configuration option to a local address on the Incus server.
...
[[*!*](#network_zone-common:dns.contact)]
...
[[*!*](#network_zone-common:dns.nameservers)]
...
[[*!*](#network_zone-common:network.nat)]
...
[[*!*](#network_zone-common:peers.NAME.address)]
...
[[*!*](#network_zone-common:peers.NAME.key)]
...
You can restrict projects to specific domains and sub-domains through the [`restricted.networks.zones`](../../reference/projects/#project-restricted:restricted.networks.zones) project configuration key.
...
To do so, use the [[[`incus`]` `[`network`]` `[`zone`]` `[`record`]]](../../reference/manpages/incus/network/zone/record/#incus-network-zone-record-md) command.
...
You cannot edit an entry (except if you edit the full record with [[[`incus`]` `[`network`]` `[`zone`]` `[`record`]` `[`edit`]]](../../reference/manpages/incus/network/zone/record/edit/#incus-network-zone-record-edit-md)), but you can delete entries with the following command:
