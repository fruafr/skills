...
If you have projects that are [confined to specific users](../../explanation/projects/#projects-confined), only users with full access to Incus can see all projects.
...
See [[[`incus`]` `[`project`]` `[`list`]` `[`--help`]]](../../reference/manpages/incus/project/list/#incus-project-list-md) for more information.

## Switch projects

By default, all commands that you issue in Incus affect the project that you are currently using.
To see which project you are in, use the [[[`incus`]` `[`project`]` `[`list`]]](../../reference/manpages/incus/project/list/#incus-project-list-md) command.
...
To list the instances in a specific project, add the [`--project`] flag to the [[[`incus`]` `[`list`]]](../../reference/manpages/incus/list/#incus-list-md) command.
For example:
...
If you create a project with the default settings, profiles are isolated in the project ([[[`features.profiles`]]](../../reference/projects/#project-features) is set to [`true`]).
...
[`~$`]` `[`incus`]` `[`launch`]` `[`images:debian/12`]` `[`my-instance`]

[`Creating`]` `[`my-instance`][`Error:`]` `[`Failed`]` `[`instance`]` `[`creation:`]` `[`Failed`]` `[`creating`]` `[`instance`]` `[`record:`]` `[`Failed`]` `[`initializing`]` `[`instance:`]` `[`Failed`]` `[`getting`]` `[`root`]` `[`disk:`]` `[`No`]` `[`root`]` `[`device`]` `[`could`]` `[`be`]` `[`found`]
