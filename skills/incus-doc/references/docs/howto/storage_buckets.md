...
See the following sections for instructions on how to create, configure, view and resize [Storage buckets](../../explanation/storage/#storage-buckets) and how to manage storage bucket keys.
...
To configure the S3 address, set the [`core.storage_buckets_address`](../../server_config/#server-core:core.storage_buckets_address) server configuration option.
For example:
...
See [Storage buckets](../../explanation/storage/#storage-buckets) for detailed information.
