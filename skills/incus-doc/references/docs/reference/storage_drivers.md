...
-   [LINSTOR - [`linstor`]](../storage_linstor/)
-   [TrueNAS - [`truenas`]](../storage_truenas/)
...
Where possible, Incus uses the advanced features of each storage system to optimize operations.
  ...
  -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------- ------- ----- ------------------------------------------------------------------------------------------------------- ---------- -------- ------------- --------- ---------
  [Optimized image storage](#storage-optimized-image-storage)                                                                                                                                     no                                                                                                      yes     yes   yes                                                                                                     yes        n/a      n/a           yes       yes
  ...
  [Optimized volume transfer](#storage-optimized-volume-transfer)                                                                                                                                 no                                                                                                      yes     no    yes                                                                                                     yes        n/a      n/a           no        no
  ...
  Storage driver usable inside a container                                                                                                                                                                                               yes                                                                                                     yes     no    yes[[\[]1[\]]](#id4){#id2 .footnote-reference .brackets role="doc-noteref"}   no         n/a      n/a           no        no
  Restore from older snapshots (not latest)                                                                                                                                                                                              yes                                                                                                     yes     yes   no                                                                                                      yes        yes      n/a           no        no
  Storage quotas                                                                                                                                                                                                                         yes[[\[]2[\]]](#id5){#id3 .footnote-reference .brackets role="doc-noteref"}   yes     yes   yes                                                                                                     yes        yes      yes           yes       yes
...
See [Data storage location](../../explanation/storage/#storage-location) for more information.
...
[[\[][1](#id2){role="doc-backlink"}[\]]]

Requires [[[`zfs.delegate`]]](../storage_zfs/#storage-zfs-vol-config) to be enabled.

[[\[][2](#id3){role="doc-backlink"}[\]]]
