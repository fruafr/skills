...
1.  Install the Incus package
    ...
    For detailed distribution-specific instructions, refer to [How to install Incus](../../installing/#installing).

2.  Allow your user to control Incus
...
3.  Initialize Incus
    ...
    If you want to tune the initialization options, see [How to initialize Incus](../../howto/initialize/#initialize) for more information.
...
See [Images](../../images/#images) for more information about the images that Incus uses.

Now, let's start by launching a few instances.
With *instance*, we mean either a container or a virtual machine.
See [About containers and VMs](../../explanation/containers_and_vms/#containers-and-vms) for information about the difference between the two instance types.
...
4.  Launch a VM called [`debian-vm`] using the Debian 12 image:
...
See [Instance options](../../reference/instance_options/#instance-options) for an overview.
...
6.  Depending on the instance type and the storage drivers that you use, there are more configuration options that you can specify.
    ...
    1.  Check the current size of the root disk device of the Debian VM:
        ...
        [`Filesystem`]`      `[`Size`]`  `[`Used`]` `[`Avail`]` `[`Use%`]` `[`Mounted`]` `[`on`][`/dev/root`]`       `[`9.6G`]`  `[`1.4G`]`  `[`8.2G`]`  `[`15%`]` `[`/`][`tmpfs`]`           `[`483M`]`     `[`0`]`  `[`483M`]`   `[`0%`]` `[`/dev/shm`][`tmpfs`]`           `[`193M`]`  `[`604K`]`  `[`193M`]`   `[`1%`]` `[`/run`][`tmpfs`]`           `[`5.0M`]`     `[`0`]`  `[`5.0M`]`   `[`0%`]` `[`/run/lock`][`tmpfs`]`            `[`50M`]`   `[`14M`]`   `[`37M`]`  `[`27%`]` `[`/run/incus_agent`][`/dev/sda15`]`      `[`105M`]`  `[`6.1M`]`   `[`99M`]`   `[`6%`]` `[`/boot/efi`]
        :::
    ...
    4.  Check the size of the root disk device again:
        ...
        [`Filesystem`]`      `[`Size`]`  `[`Used`]` `[`Avail`]` `[`Use%`]` `[`Mounted`]` `[`on`][`/dev/root`]`        `[`29G`]`  `[`1.4G`]`   `[`28G`]`   `[`5%`]` `[`/`][`tmpfs`]`           `[`483M`]`     `[`0`]`  `[`483M`]`   `[`0%`]` `[`/dev/shm`][`tmpfs`]`           `[`193M`]`  `[`588K`]`  `[`193M`]`   `[`1%`]` `[`/run`][`tmpfs`]`           `[`5.0M`]`     `[`0`]`  `[`5.0M`]`   `[`0%`]` `[`/run/lock`][`tmpfs`]`            `[`50M`]`   `[`14M`]`   `[`37M`]`  `[`27%`]` `[`/run/incus_agent`][`/dev/sda15`]`      `[`105M`]`  `[`6.1M`]`   `[`99M`]`   `[`6%`]` `[`/boot/efi`]
        :::

See [How to configure instances](../../howto/instances_configure/#instances-configure) and [Instance configuration](../../explanation/instance_config/#instance-config) for more information.
...
See [Use snapshots for instance backup](../../howto/instances_backup/#instances-snapshots) for more information.
